...
1)This folder contains the libraries that stores the Firmware for DMP(Digital Motion Processor) present inside the Mpu series of IMUS from Invensense
2)THese invensense IMUS donot have permanent memory for storing Firmware. So the hex binary code for IMU's DMP is carried inside this IMU;
